...
const parentCountryAliases: Record<string, string[]> = {
  "Africa/Johannesburg": ["south africa", "main territory of south africa"],
  "America/Adak": ["united states", "usa", "aleutian islands"],
  "America/Anchorage": ["united states", "usa", "alaska"],
  "America/Aruba": ["kingdom of the netherlands", "netherlands"],
  "America/Cayenne": ["france", "french guiana"],
  "America/Cayman": ["united kingdom", "cayman islands"],
  "America/Chicago": ["united states", "usa", "central time zone"],
  "America/Curacao": ["kingdom of the netherlands", "netherlands"],
  "America/Denver": ["united states", "usa", "mountain time zone"],
  "America/Grand_Turk": ["united kingdom", "turks and caicos islands"],
  "America/Guadeloupe": ["france", "guadeloupe", "saint barthelemy", "saint martin"],
  "America/Halifax": ["canada", "atlantic time"],
  "America/Kralendijk": ["kingdom of the netherlands", "netherlands", "caribbean netherlands"],
  "America/Los_Angeles": ["united states", "usa", "pacific time zone"],
  "America/Martinique": ["france", "martinique"],
  "America/Mexico_City": ["mexico", "central mexico"],
  "America/Miquelon": ["france", "saint pierre and miquelon"],
  "America/New_York": ["united states", "usa", "eastern time zone"],
  "America/Noronha": ["brazil", "fernando de noronha"],
  "America/Nuuk": ["denmark", "greenland"],
  "America/Puerto_Rico": ["united states", "usa", "puerto rico", "u.s. virgin islands", "us virgin islands"],
  "America/Rio_Branco": ["brazil", "acre", "western amazonas"],
  "America/Scoresbysund": ["denmark", "greenland"],
  "America/Sao_Paulo": ["brazil", "brasilia time", "main territory of brazil"],
  "America/St_Johns": ["canada", "newfoundland time"],
  "America/Thule": ["denmark", "greenland", "pituffik"],
  "America/Toronto": ["canada", "eastern canada"],
  "America/Vancouver": ["canada", "pacific canada"],
  "America/Winnipeg": ["canada", "central canada"],
  "Asia/Chita": ["russia", "yakutsk time"],
  "Asia/Dubai": ["united arab emirates"],
  "Asia/Irkutsk": ["russia", "irkutsk time"],
  "Asia/Kamchatka": ["russia", "kamchatka time", "chukotka"],
  "Asia/Krasnoyarsk": ["russia", "krasnoyarsk time"],
  "Asia/Makassar": ["indonesia", "central indonesia", "bali", "sulawesi"],
  "Asia/Magadan": ["russia", "magadan time", "sakhalin"],
  "Asia/Omsk": ["russia", "omsk time"],
  "Asia/Pontianak": ["indonesia", "western indonesia", "west kalimantan"],
  "Asia/Samarkand": ["uzbekistan"],
  "Asia/Singapore": ["singapore"],
  "Asia/Tokyo": ["japan"],
  "Asia/Urumqi": ["china", "xinjiang"],
  "Asia/Vladivostok": ["russia", "vladivostok time"],
  "Asia/Yakutsk": ["russia", "yakutsk time"],
  "Asia/Yekaterinburg": ["russia", "yekaterinburg time"],
  ...
  "Atlantic/South_Georgia": ["united kingdom", "south georgia", "south sandwich islands"],
  "Atlantic/Stanley": ["united kingdom", "falkland islands"],
  ...
  "Australia/Sydney": ["australia", "main territory of australia"],
  "Europe/Copenhagen": ["denmark", "main territory of denmark"],
  "Europe/Gibraltar": ["united kingdom", "gibraltar"],
  "Europe/Kaliningrad": ["russia", "kaliningrad time"],
  "Europe/Lisbon": ["portugal", "main territory of portugal"],
  "Europe/London": ["united kingdom", "uk", "main territory of united kingdom"],
  "Europe/Madrid": ["spain", "main territory of spain"],
  "Europe/Moscow": ["russia", "moscow time"],
  "Europe/Paris": ["france", "metropolitan france", "main territory of france"],
  "Europe/Samara": ["russia", "samara time"],
  "Indian/Chagos": ["united kingdom", "british indian ocean territory"],
  "Indian/Christmas": ["australia", "christmas island"],
  "Indian/Cocos": ["australia", "cocos islands", "keeling islands"],
  "Indian/Mayotte": ["france", "mayotte"],
  "Indian/Reunion": ["france", "reunion"],
  "Pacific/Chatham": ["new zealand", "chatham islands"],
  "Pacific/Fakaofo": ["new zealand", "tokelau"],
  "Pacific/Gambier": ["france", "gambier islands"],
  "Pacific/Guam": ["united states", "usa", "guam", "northern mariana islands"],
  "Pacific/Honolulu": ["united states", "usa", "hawaii"],
  "Pacific/Kanton": ["kiribati", "phoenix islands"],
  "Pacific/Kiritimati": ["kiribati", "line islands"],
  "Pacific/Kosrae": ["micronesia", "federated states of micronesia", "kosrae", "pohnpei"],
  "Pacific/Marquesas": ["france", "marquesas islands"],
  "Pacific/Niue": ["new zealand", "niue"],
  "Pacific/Norfolk": ["australia", "norfolk island"],
  "Pacific/Noumea": ["france", "new caledonia"],
  "Pacific/Pago_Pago": ["united states", "usa", "american samoa", "midway atoll"],
  "Pacific/Pitcairn": ["united kingdom", "pitcairn islands"],
  "Pacific/Port_Moresby": ["papua new guinea"],
  "Pacific/Rarotonga": ["new zealand", "cook islands"],
  "Pacific/Tahiti": ["france", "society islands", "tuamotus", "austral islands"],
  "Pacific/Tarawa": ["kiribati", "gilbert islands"],
  "Pacific/Wake": ["united states", "usa", "wake island"],
